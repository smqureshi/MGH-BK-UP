...
public class ATNALogDAO {
    ...
    public ATNALogStore getFilteredATNALogs(ATNALog filterBean, String endTime, final Integer pageNum) throws SQLException {
        ...
        if(StringUtils.isNotEmpty(endTime) && StringUtils.isNotEmpty(filterBean.getCreationDateTime())){
            sqlStatement += "AND logtime between '" + filterBean.getCreationDateTime() + "' " + 
        "AND '" + endTime + "' ";
        }
        else if(StringUtils.isNotEmpty(endTime) && StringUtils.isEmpty(filterBean.getCreationDateTime()) ){
            sqlStatement += "AND logtime <='" + endTime + "' ";
        }        
        else if(StringUtils.isNotEmpty(filterBean.getCreationDateTime()) ){
